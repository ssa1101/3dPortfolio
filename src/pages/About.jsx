...
const About = () => {
  ...
  <section className='max-container'>
    <h1 className='head-text'>
      Hi, I'm <span className="blue-gradient_text font-semibold drop-shadow">Shifa</span>
    </h1>
    <div className='mt-5 flex flex-col gap-3 text-slate-500'>
    <p>Software Engineering student based in Phoenix, AZ, passionate about developing full-stack applications.</p>
    </div>
    <div className='py-10 flex fex-col'>
